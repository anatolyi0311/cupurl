...
// func (m *MockRepo) Get(hash string, _ zap.SugaredLogger) (model.ShortURL, error) {
// 	args := m.Called(hash)
// 	return model.ShortURL{ShortURL: args.String(0)}, fmt.Errorf("")
// }
...
// func (m *MockRepo) Set(url, hash string, _ zap.SugaredLogger) (model.ShortURL, error) {
// 	args := m.Called(url, hash)
// 	return model.ShortURL{OriginalURL: args.String(0), ShortURL: args.String(1)}, fmt.Errorf("")
// }
...
// 			if tt.repoIsOn {
// 				mockRepo.On("Set", tt.url, tt.wantHash).Return(model.ShortURL{ShortURL: tt.wantHash}, tt.wantErr)
// 			}
// 			// ..3.
// 			gotHash, err := s.SetURL(tt.url)
// 			// ..4.
// 			assert.Equal(t, tt.wantHash, gotHash.ShortURL)
...
// 			mockRepo := s.repo.(*MockRepo)
// 			if tt.repoIsOn {
// 				mockRepo.On("Get", tt.wantHash).Return(model.ShortURL{OriginalURL: tt.wantURL, ShortURL: tt.wantHash}, tt.wantErr)
// 			}
// 			// ..3.
