...
import (
	url3 "github.com/anatolyi0311/cupurl/internal/api/grpc/url"
	url4 "github.com/anatolyi0311/cupurl/internal/api/http/url"
	"github.com/anatolyi0311/cupurl/internal/config"
	url2 "github.com/anatolyi0311/cupurl/internal/repositories/url"
	"github.com/anatolyi0311/cupurl/internal/services/url"
...
func (s *serviceProvider) ShortenerHandler(dbPool *pgxpool.Pool, baseUrl, storagePath, subnetsStr string, cfg *config.ENVConfig) *url4.Handlers {
	if s.shortenerHandler == nil {
		userHandler := url4.NewHandlers(s.ShortenerService(dbPool, baseUrl, storagePath), subnetsStr, cfg)
